...
def print_results(results_dic, results_stats_dic, model, 
    ...
    for key in results_stats_dic:
        ...
        if key[0] == 'p':
                ...
                print( "{:20}: {:4f}".format( (key + ' is '),   results_stats_dic[key]) )
    ...
    if (print_incorrect_dogs and 
        ...
        for key in results_dic:
            ...
            if ((results_dic[key][3] == 1) and (results_dic[key][4] == 0)) :
                    print("{:15}:{:70}".format('Image name',key))
                    print("{:15}:{:70}".format( 'PetLabel is',results_dic[key][0]))
                    print("{:15}:{:70}".format( 'ClassLabel is',results_dic[key][1]))
